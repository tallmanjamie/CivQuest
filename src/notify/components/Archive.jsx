// src/notify/components/Archive.jsx
...
export default function Archive({ 
  ...
  const filteredLogs = useMemo(() => {
    return logs.filter(log => {
      ...
      // UI Filters - Organization filter applies to all roles
      if (filterOrg !== 'all' && log.organizationId !== filterOrg) {
        return false;
      }
      
      // Feed type filter applies to all roles
      if (filterType !== 'all' && log.notificationId !== filterType) {
        return false;
      }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full p-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-[#004E7C] outline-none"
                >
              ...
              <div>
                ...
                <select 
                  ...
                  className="w-full p-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-[#004E7C] outline-none disabled:bg-slate-100 disabled:text-slate-400"
                >
