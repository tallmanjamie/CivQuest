          ...
          {config?.ui?.info?.enabled && (
            <div className="relative">
              <button
                ...
                className="p-1.5 bg-white rounded-full shadow-md hover:shadow-lg hover:scale-110 transition-all"
                title="Information"
              >
                <Info className="w-4 h-4" strokeWidth={2.5} style={{ color: colors.bg700 }} />
              </button>
              <InfoPopup
